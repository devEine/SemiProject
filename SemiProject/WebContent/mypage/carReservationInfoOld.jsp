...
<section> <!-- class="management"  -->
			<br>
			<h2 style="text-align: center">회원님의 이전 예약 내역</h2>
			...
			<table border="1" id="mainWrapper" style=" text-align: center;">
				<tr style="text-align: center; font-weight: bold; color: #fff;">
					...
					<td style="background-color: #CEE5D0;">리뷰작성</td>
				</tr>
				...
				<c:forEach var="cdto" items="${boardList }">
					<tr>
						...
						<td><input class="btn" type="button" value="작성하기" onclick="location.href='./ReviewWrite.bo?&rsvt_name=${cdto.rsvt_name}';"></td>
								...
								<c:if test="${cnt != 0 }">
									<ul>
										<li><c:if test="${startPage > pageBlock }">
												<a href="./OldCarReservationManagementPro.bo?pageNum=${startPage-pageBlock}">&lt;</a>
											</c:if></li>

										<li class=""><c:forEach var="i" begin="${startPage }"
												end="${endPage }" step="1">
												<a href="./OldCarReservationManagementPro.bo?pageNum=${i }">${i }</a>
											</c:forEach></li>
