...
<script type="text/javascript">
	...
	$(document).on('mouseleave', '.slidingMenu', function() {
		if (!$(this).hasClass('.slidingMenu')) {
			$('.dmenu').slideUp(700);
		}
	});
</script>
...
<!-- ---------------////// 슬라이딩 메뉴 적용 //////------------------------ -->
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html" style="position: relative;">CHACA<span>CHACA</span></a>
	      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#ftco-nav" aria-controls="ftco-nav" aria-expanded="false" aria-label="Toggle navigation">
	        <span class="oi oi-menu"></span> Menu
	      </button>

			<div class="topMenu navbar-collapse" id="ftco-nav">
				<ul class="slidingMenu navbar-nav ml-auto">
					<li class="nav-item"><a href="index.html" class="nav-link">Home</a></li>
					<li class="nav-item"><a href="about.html" class="nav-link">이용안내</a>
						<ul class="dmenu">
							<li><a href="#a" class="nav-dlink">아래메뉴1</a></li>
						</ul></li>
					<li class="nav-item"><a href="services.html" class="nav-link">요금안내</a>
						<ul class="dmenu">
							<li><a href="#a" class="nav-dlink">아래메뉴1</a></li>
						</ul></li>
					<li class="nav-item"><a href="pricing.html" class="nav-link">예약하기</a>
						<ul class="dmenu">
							<li><a href="#a" class="nav-dlink">아래메뉴1</a></li>
						</ul></li>
					<li class="nav-item"><a href="car.html" class="nav-link">고객센터</a>
						<ul class="dmenu">
							<li><a href="review.jsp" class="nav-dlink">이용후기</a></li>
							<li><a href="contact.html" class="nav-dlink">문의하기</a></li>
						</ul></li>
					<li class="nav-item active"><a href="login.html" class="nav-link">마이페이지</a>
						<ul class="dmenu">
							<li><a href="joinUpdate.html" class="nav-dlink">회원정보수정</a></li>
							<li><a href="reservUpdate.html" class="nav-dlink">예약내역확인</a></li>
						</ul></li>
				</ul>
			</div>
		</div>
		...
		<div class="collapse navbar-collapse" id="ftco-nav">
			<ul class="navbar-nav ml-auto">
				...
				<div style="width: 100px; height: 50px; /* border:1px solid black;  */
							line-height: 20px; margin-left: 30px; font-size: small; 
					...
					if(id == null) {
						%>
							<a class="nav-item" href="./Join.bo">회원가입</a> <br>
							<a class="nav-item" href="./Login.bo" id="login">로그인</a>
					<%
						} else {
					%>
						<span style="font-size: xx-small; color:white;">${sessionScope.loginID }님</span>
						<br>
						<a class="nav-item" href="./Logout.bo" id="logout">로그아웃</a> <br>
