            		...
            		<form action="./JoinAction.bo" method="post" class="p-2 contact-form" name="form" onsubmit="return join();">
	              		<div class="form-group">
	              			<p class="d-flex justify-content-center mt-3 mb-0 d-block">
	                			...
	                			<input type="email" class="form-control" placeholder="아이디 확인을 눌러주세요" name="id_email" id="id_email" value="${id_email }" readonly><input type="button" value="아이디 확인" class="check" onclick="idCheck();">
