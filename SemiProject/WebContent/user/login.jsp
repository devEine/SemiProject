      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs"><span class="mr-2"><a href="./Main.bo">Home <i class="ion-ios-arrow-forward"></i></a></span></p>
...
<!-- ---------------------- 본문 -------------------------------- -->
       		<div class="row d-flex justify-content-center">
       			<div class="col-md-5 ">
            		<form action="./LoginAction.bo" method="post" class="p-2 contact-form">
	              		<div class="form-group">
	                		아이디(이메일): <input type="text" class="form-control" placeholder="이메일을 입력해주세요" name="id_email">
	              		</div>
	              		<div class="form-group">
	              		...
	              		<div class="form-group">
	             			<p class="d-flex justify-content-center mt-5 mb-0 d-block">
	                			<input type="submit" value="로그인" id="btn" class="btn btn-primary py-3 px-5 mr-3 ">
	                			<input type="button" value="회원가입" id="btn" class="btn btn-primary py-3 px-5 ml-3 " onclick="location.href='./Join.bo';">
	              			</p><br>
							<a id="kakao-login-btn" href="javascript:kakaoLogin();" style="padding-left: 20px;">
								<img src="./images/certi_kakao_login.png" style="width: 340px; height:70px;">
							</a>
	              		</div>
            		</form>
          		</div>
...
Kakao.init('dfca5b3863564f021175c274a0079e2a'); //발급받은 키 중 javascript키를 사용해준다.
		...
		success: function(response) {
			...
			window.Kakao.API.request({ // 사용자 정보 가져오기 
				...
				success: (res) => {
					...
					var id_email = res.kakao_account.email;
					var name = res.properties.nickname;
					console.log(id_email);
					console.log(name);
					window.location.href='./LoginKakao.bo?id_email='+id_email+'&name='+name; // 리다이렉트 되는 코드
				}
			});
		},
		fail: function(error) {
