		...
		%>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="./Informatin.bo" class="nav-link">이용안내</a></li>
...
<section class="paymentresult">
	<div class="thanks">예약이 완료되었습니다.<br>
						좋은 서비스로 보답하겠습니다.<br>
						감사합니다😀 </div>
	<div class="button"><input type="button" value="예약정보조회" id="btn" class="btn btn-primary py-3 px-5 mr-3" onclick="location.href='./ReservationInfo.bo';">
            ...
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                ...
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">info@chacachaca.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
