					...
					<div class="col-md-12 d-flex ftco-animate fadeInUp ftco-animated justify-content-center">
						<div class="col-md-30 ">
							<fieldset>
								...
								<form action="./ReviewFileWriteAction.bo" class="bg-light p-5 contact-form" enctype="multipart/form-data" method="post">
									<div class="form-group">
										<span style="width: 80%;">아이디</span> 
										<input type="email" class="form-control" name="id" placeholder="아이디(이메일)" style="width:50%" value="${rsvt_id }">
									</div>
									<div class="form-group">
										<span style="width: 80%;">이름</span>
										<input type="text" class="form-control" name="name" placeholder="예약자 성함" style="width:50%" value="${rsvt_name }">
									</div>
									<div class="form-group">
							...
							<div class="star">
								...
								<!-- ///////////////별점/////////////// -->
									...
									<input type="submit" value="제출하기" style="margin-top: 0px;" class="Bbtn btn1" > <div class="form-group">
									</div>
									</div>
								</form>
							</fieldset>
